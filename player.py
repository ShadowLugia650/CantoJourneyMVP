...
def generate_sprite():
    ...
    sprite.blit(render.assets.img.PChara.Body.get(str(customs.skin)), (0, 0))
    ...
    sprite.blit(render.assets.img.PChara.Head.get(str(customs.skin)), (0, 0))
    ...
    head_sprite.insert("large", pygame.Surface(render.assets.img.PChara.Face.get("0c0").get_size(), pygame.SRCALPHA))
    head_sprite.large.blit(render.assets.img.PChara.Head.get(str(customs.skin)), (0 ,0))
    head_sprite.large.blit(render.assets.img.PChara.Face.get(str(customs.face) + "c" + str(customs.face_colour)), (0, 0))
    head_sprite.large.blit(render.assets.img.PChara.Hair.get(str(customs.hair) + "c" + str(customs.hair_colour)), (0, 0))
